...
public class GlossEntry{
    ...
    public static class JsonSimpleFactory
    {
        ...
        public static String toJson(List<GlossEntry> list) {
            JSONArray array = new JSONArray();
            for(GlossEntry obj : list)
            {
        ...
        public static List<GlossEntry> fromJsonArray(String jsonArrayString) {
            JSONArray jsonArray = (JSONArray)JSONValue.parse(jsonArrayString);
            List<GlossEntry> result = new ArrayList<GlossEntry>();
